...
%            - is it figure, of Figure, or Fig., or...? Check
%            - fix references data and parenthesis style (see notes in reference section)
%
%
%
% CHECKLIST/TODO:
...
%\includegraphics[height=7cm,right]{images/sensitivity.png}
%\end{minipage}%%% to prevent a space
%\begin{minipage}{0.4\textwidth}
%\scriptsize
%\begin{equation}
%\begin{split}
%\sigma &= {Ex(T0+\Delta T0)-Ex(T0) \over Ex(T0)} = \\
%&= { { Q \left( 1-{T0+ \Delta T0 \over T} \right) } - { Q \left( 1-{T0 \over T} \right) } \over { Q \left( 1-{T0 \over T} \right) } } = \\
%&= { \Delta T0 \over T0 - T }\\
%\end{split}
%\end{equation}
%\null
...
%Alternative: equation on top of figure:
